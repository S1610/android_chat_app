...
import 'package:android_chat_app/states/totals_notifier.dart'; // Ensure this imports CardInvoiceData
          ...
          children: [
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  Hero(
                    tag: _selectedModelImageUrl,
                    child: GestureDetector(
                      onTap: () => _showFullScreenImage(context, _selectedModelImageUrl),
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.asset(
                          _selectedModelImageUrl, // Use Image.asset for local assets
                          height: 100,
                          width: 100,
                          fit: BoxFit.cover,
