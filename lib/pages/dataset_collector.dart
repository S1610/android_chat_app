import 'package:android_chat_app/widgets/class_widget.dart';
...
class _DatasetCollectorState extends State<DatasetCollector> {
  ...
  void addNewClass() {
    showDialog(
      context: context,
      builder: (context) {
        TextEditingController classNameController = TextEditingController(text: "Class ${classes.length + 1}");
        return AlertDialog(
            ...
            child: Padding(padding: const EdgeInsets.all(8.0),
              child: Column(
                children: [
                  ...
                  const Text("Train your model to see predictions here.",
                    style: TextStyle(
                      fontSize: 12,
                      color: Colors.grey
                    )
                                ...
                                Column(
                                  ...
                                  children: [
                                    Row (
                                      ...
                                      children: [
                                        Text("Batch Size"),
                                        Text(custom_Batch_Sizes[Batch_Index].toString()),
                                        ],
                                      ),
                                      Slider(
